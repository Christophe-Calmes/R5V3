...
Constituant le contrat entre l'association <?=$dataSite[0]['titre']?>, l’Utilisateur, l’accès au site doit être précédé de
...
<p>L’édition du site <?=$dataSite[0]['titre']?> est assurée par l'association <?=$dataSite[0]['titre']?> __Ajouter vos coordonnées.
...
Le site <?=$dataSite[0]['titre']?> permet d’accéder gratuitement aux services suivants:
 <ul>
    <li>Consulter les actualités de l'association <?=$dataSite[0]['titre']?>, </li>
 </ul>
...
<ul>
    ...
    <li>Par simple demande à l'association <?=$dataSite[0]['titre']?></li>
...
un ou plusieurs événement gratuit au payant. l'association <?=$dataSite[0]['titre']?> en tant que lieu privé se réserve le droit de refuser la participation
